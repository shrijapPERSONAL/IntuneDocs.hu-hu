...
### [Alkalmazások telepítése a Céges portál alkalmazásból](install-apps-cpapp-windows.md) 
### [Az eszköz távoli zárolása a Céges portál alkalmazásban](remote-lock-your-device-cp-app.md)   
### [Az eszköz átnevezése a Céges portál alkalmazásban](rename-your-device-cpapp.md) 
