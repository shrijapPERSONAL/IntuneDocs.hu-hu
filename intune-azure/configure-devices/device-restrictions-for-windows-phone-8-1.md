...
# <a name="windows-phone-81-device-restriction-settings-in-intune-azure-preview"></a>A Windows Phone 8.1 rendszerű eszközök korlátozására vonatkozó beállítások az Azure-beli Intune előzetesében
