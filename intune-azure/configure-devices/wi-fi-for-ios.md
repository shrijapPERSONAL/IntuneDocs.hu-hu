---
title: "Wi-Fi-beállítások iOS-eszközökhöz az Intune-ban | Intune az Azure-on – előzetes | Microsoft Docs"
description: "Intune az Azure-on – előzetes: Útmutató a Wi-Fi kapcsolatok iOS-eszközökön való konfiguráláshoz használható Intune-beállításokhoz."
keywords: 
author: robstackmsft
ms.author: robstack
manager: angrobe
...
# <a name="intune-wi-fi-settings-for-ios-devices-in-intune-azure-preview"></a>Az Intune Wi-Fi-beállításai iOS-eszközökhöz az Azure-beli Intune előzetesében
