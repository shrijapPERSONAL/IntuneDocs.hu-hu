---
title: "Mennyiségi programban vásárolt iOS-alkalmazások kezelése | Intune az Azure-on – előzetes | Microsoft Docs"
...
# <a name="how-to-manage-ios-apps-you-purchased-through-a-volume-purchase-program"></a>Mennyiségi vásárlási program keretében vásárolt iOS-alkalmazások kezelése
