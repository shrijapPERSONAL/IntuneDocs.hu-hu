...
# <a name="how-to-add-android-store-apps-to-intune"></a>Androidos áruházbeli alkalmazások hozzáadása az Intune-hoz
...
7. Az **Alkalmazás szerkesztése** panelen konfigurálja az alábbi információkat. Ha ezzel elkészült, kattintson a **Hozzáadás** lehetőségre. A választott alkalmazástól függően egyes értékek automatikusan kitöltődhetnek a panelen:
