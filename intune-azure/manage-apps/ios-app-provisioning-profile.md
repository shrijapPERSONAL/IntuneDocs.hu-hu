...
A profilt rendelje hozzá a szükséges iOS-eszközökhöz. További információt az [Eszközprofilok hozzárendelése](../configure-devices/how-to-assign-device-profiles.md) című útmutató lépéseit használva talál.
