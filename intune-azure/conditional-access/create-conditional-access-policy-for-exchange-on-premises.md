...
- Az [Exchange Active Sync helyszíni Exchange-összekötőt](install-intune-on-premises-exchange-connector.md) kell használni, amely összekapcsolja az Intune-t a helyszíni Exchange-dzsel.
