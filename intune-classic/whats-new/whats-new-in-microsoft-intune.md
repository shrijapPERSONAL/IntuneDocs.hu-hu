...
Mostantól tömegesen is regisztrálhatja a Windows 10 alkotói frissítését futtató készülékeket az Azure Active Directoryhoz és az Intune-hoz az Azure AD-bérlőben a Windows Konfigurációtervező /intune-classic/deploy-use/bulk-enroll-windows) segítségével, kiépítési csomagot készíthet a Windows Konfigurációtervezővel, amellyel az eszközöket az Azure AD-bérlőhöz kapcsolhatja, majd alkalmazhatja a csomagot azokra a vállalati eszközökre, amelyeket tömegesen regisztrálni és felügyelni kíván. A csomagok alkalmazását követően az eszközök csatlakoznak az Azure AD-hez, regisztrálnak az Intune-ban, és készen állnak az Azure AD-felhasználók bejelentkezésére.  Az Azure AD-felhasználók általános jogú felhasználók ezeken az eszközökön, akik megkapják majd a kijelölt szabályzatokat és a kötelező alkalmazásokat. Az önkiszolgáló és a Céges portált használó módszer jelenleg nincs támogatva.
...
> [!Note]
> Az Azure Portal előzetes verziójának frissítései ebben a hónapban jelennek meg. Azonban az Intune szolgáltatás bevezetési módja miatt elképzelhető, hogy a változások nem azonnal érhetők el.  A Portal új funkcióinak megjelenése előtt a szolgáltatás többféle összetevőjének egymás utáni frissítésére van szükség. Az Azure Portal előzetes verziójának változásai fokozatosan jelennek meg ebben a hónapban. A változások teljes listáját a [Microsoft Intune előzetes verziójának újdonságai](/intune/whats-new) című témakörben találja.
...
* [Az Azure előzetes verziójának újdonságai](https://docs.microsoft.com/intune/whats-new)
* [A Céges portál felhasználói felületének újdonságai](/intune-classic/whats-new/whats-new-in-company-portal-ui)
