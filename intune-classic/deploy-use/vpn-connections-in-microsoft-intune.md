...
**Kapcsolat típusa**     |  Válasszon egyet a következő kapcsolattípusok közül a VPN-profilban való használathoz: **Cisco AnyConnect** (nem érhető el a Windows 8.1 vagy Windows Phone 8.1 rendszerhez), **Pulse Secure**, **Citrix**, **F5 Edge Client**, **SonicWall Mobile Connect**, **CheckPoint Mobile VPN**.
...
**Bejelentkezési csoport vagy tartomány**|Adja meg annak a bejelentkezési csoportnak vagy tartománynak a nevét, amelyhez csatlakozni szeretne. Ez a beállítás csak akkor látható, ha a kapcsolat típusa **SonicWall Mobile Connect**.
