...
|**0x80043001**|A beléptetési csomag elavult.|Töltse le és telepítse az aktuális ügyfélszoftver-csomagot a **Felügyelet** munkaterületen. Útmutatásért lásd [A Windows rendszerű számítógépügyfél telepítése a Microsoft Intune-nal](/intune-classic/deploy-use/install-the-windows-pc-client-with-microsoft-intune) című témakört.|
...
|**0x80043009**|Az ügyfélszámítógép már be van léptetve a szolgáltatásba.|Az ügyfélszámítógépet el kell távolítania, mielőtt újból beléptetheti a szolgáltatásba. Útmutatásért lásd az [Eszközök kivonása a Microsoft Intune-nal való felügyelet alól](/intune-classic/deploy-use/retire-devices-from-microsoft-intune-management) című témakört.|
