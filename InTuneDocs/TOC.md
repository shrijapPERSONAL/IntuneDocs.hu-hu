...
##### [A Mobile Threat Defense beállítása](deploy-use/device-threat-protection-subscription-setup.md)
##### [A Mobile Threat Defense engedélyezése](deploy-use/device-threat-protection-enable.md)
##### [Mobile Threat Defense-alkalmazások telepítése](deploy-use/device-threat-protection-apps.md)
##### [A Mobile Threat Defense megfelelőségi szabályzatának engedélyezése](deploy-use/device-threat-protection-policy.md)
