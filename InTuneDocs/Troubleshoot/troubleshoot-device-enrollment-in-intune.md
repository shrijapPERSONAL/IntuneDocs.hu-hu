...
**Hiba:** **Profiltelepítési hiba** üzenet jelenik meg egy iOS- vagy Android-eszközön.
...
3.  iOS-eszköz esetén nyissa meg a [https://portal.manage.microsoft.com](https://portal.manage.microsoft.com) portált, és amikor a rendszer kéri, telepítse a profilt.

4.  Ellenőrizze, hogy az iOS rendszerhez készült Safari és az Androidhoz készült Chrome az alapértelmezett böngésző-e, és a cookie-k engedélyezettek-e.
