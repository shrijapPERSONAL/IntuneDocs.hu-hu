...
# Az Android for Work-eszközök megfelelőségi szabályzatainak beállításai a Microsoft Intune-ban
...
- **Jelszó erőssége:** Ez a beállítás észleli, hogy a beállított jelszókövetelmények konfigurálva vannak-e az eszközön. E beállítás bekapcsolásával írja elő a felhasználóknak az Android-eszközök bizonyos jelszókövetelményeinek konfigurálását. A következő lehetőségek közül választhat:
