...
A TeamViewer integrációján kívül az itt szereplő összes funkciót támogatják a hibrid telepítések is (az Intune-nal bővített Configuration Manager). Az új hibrid funkciókról további információért tekintse meg a [hibrid újdonságok](https://technet.microsoft.com/en-us/library/mt718155.aspx) oldalt.
