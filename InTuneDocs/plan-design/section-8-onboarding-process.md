...
-   További információk: [konfigurációs szabályzatok hozzáadása és telepítése](https://docs.microsoft.com/intune/deploy-use/manage-settings-and-features-on-your-devices-with-microsoft-intune-policies).
