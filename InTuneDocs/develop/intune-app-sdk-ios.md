...
**Melyik ADAL bináris fájlokat használjam?** 
...
* Vegye fel a fájlneveket alkalmazás Info.plist fájljának IntuneMAMSettings szótárába, a `SplashIconFile` és a `SplashIconFile~ipad` kulcsnévvel. 
