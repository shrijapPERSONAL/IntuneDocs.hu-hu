...
A veszélyforrások elleni eszközvédelem beállításához az alábbi lépések szükségesek:
...
A Lookout Intune-nal való integrálásához a Lookout Mobility Endpoint Security-bérlő társítva lesz az Azure AD-előfizetéshez. A Lookout ügyfélszolgálatának (enterprisesupport@lookout.com) a következő információkra lesz szüksége ahhoz, hogy az előfizetést felkészítse a Lookout veszélyforrások elleni eszközvédelmi szolgáltatás használatára:  
