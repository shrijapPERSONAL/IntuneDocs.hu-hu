...
## <a name="on-premises-infrastructure-requirements-for-adfs-mfa"></a>Az ADFS Multi-Factor Authentication helyszíni infrastruktúra-követelményei
...
#### <a name="mfa-with-intune"></a>Többtényezős hitelesítés az Intune-ban
...
#### <a name="mfa-without-intune"></a>Többtényezős hitelesítés az Intune nélkül
...
## <a name="requiring-adfs-mfa-during-enrollment-of-windows-devices"></a>Többtényezős hitelesítés megkövetelése az Active Directory összevonási szolgáltatásokban windowsos eszközök regisztrálásakor
...
## <a name="set-up-device-enrollment-mfa-in-intune"></a>Többtényezős hitelesítésű eszközregisztráció beállítása az Intune-ban
>[!Important]  
