...
-   Előzőleg ismerkedjen meg a következő eljárásokkal:
    ...
    -   [Alkalmazás felvétele az Intune-ba](https://docs.microsoft.com/intune/deploy-use/add-apps)
...
[Skycure-alkalmazások, a Microsoft Authenticator alkalmazás és az iOS-es alkalmazáskonfigurációs szabályzat üzembe helyezése](https://docs.microsoft.com/intune/deploy-use/deploy-skycure-apps-microsoft-authenticator-app-and-ios-app-configuration-policy)
