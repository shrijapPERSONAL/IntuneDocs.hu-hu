...
A következő táblázat azon hibákat tartalmazza, amelyeket az iOS-es eszközök Intune-ban történő regisztrálásakor láthat. Küldje el ezt a hivatkozást a rendszergazdának. Ha nem találja az IT-rendszergazda elérhetőségeit, próbálja meg megkeresni a [Vállalati portál webhelyén](http://portal.manage.microsoft.com).
