...
Az ebben a szakaszban olvasható információk az Intune Munkahelyi portál telepítésében és az eszközök regisztrálásában nyújtanak segítséget iOS-eszközök használata esetén.
...
A jelen szakaszban található információk az iOS-eszköz Intune-beli regisztrálását követően végezhető műveletekhez nyújtanak segítséget a felhasználóknak.
