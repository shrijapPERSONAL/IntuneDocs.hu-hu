...
<div class="container">
    ...
    <ul class="pivots">
        <li>
            <a href="#manage">Felügyelet</a>
            <ul id="manage">
                <li>
                    <a href="#manage-featured">Kiemelt cikkek</a>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Intune az Azure Portalon</h3>
                                            <p>A Microsoft Intune az Azure Portalon érhető el. Ismerje meg, hogyan kezelhetőek az eszközök és alkalmazások az új portálon. </p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Ismerkedés az Intune-nal</h3>
                                            <p>Alapismeretek: Csoport és felhasználó létrehozása. Eszközök regisztrálása. Szabályzatok és alkalmazások hozzárendelése.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Hová kerültek az Intune-funkciók az Azure-ban?</h3>
                                            <p>Ha már ismeri a klasszikus Intune-konzol használatát, ez a cikk segít megtalálni a keresett funkció megfelelőjét az Azure-beli Intune-ban.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<!--                        <li>
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3><a href="/intune/what-is-intune">A teljes Intune-dokumentáció</a></h3>
                            </div>
                        </li>
                    </ul>
                </li>
                <li>
                    <a href="#manage-intro">Bevezetés</a>
                                ...
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            ...
                                            <p>Ismerje meg, hogyan nyújt az Intune eszköz-, alkalmazás- és adatfelügyeleti funkciókat mobileszközökhöz és windowsos PC-khez.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<!--                        <li>
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3><a href="/intune/what-is-intune">A teljes bevezető dokumentáció</a></h3>
                            </div>
                        </li>
                    </ul>
                </li>
               <!-- <li>
                ...
                <li>
                    <a href="#manage-plan">Telepítési terv kidolgozása</a>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Támogatott eszközök és böngészők</h3>
                                            <p>Megismerheti a szolgáltatás által támogatott eszközök és böngészők részleteit.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Útmutató az üzembe helyezési terv kialakításához, a tervezéshez és a megvalósításhoz</h3>
                                            <p>Üzembe helyezési tervet dolgozhat ki, terveket készíthet, előkészítheti az Intune-t, és elvégezheti az éles bevezetést.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Migrálási útmutató</h3>
                                            <p>Részletesen bemutatja a külső MDM-szolgáltatói megoldásról az Intune-ra való migrálás különféle lépéseit.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<!--                        <li>
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3><a href="/intune-classic/plan-design/introduction">A teljes telepítés-tervezési dokumentáció</a></h3>
                            </div>
                        </li>
                    </ul>
                </li>
                <li>
                    <a href="#manage-howto">Útmutató</a>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Feltételes hozzáférési szabályzat létrehozása</h3>
                                            <p>Az eszközök megfelelősége alapján feltételes hozzáférést konfigurálhat a helyszíni Exchange-hez.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Az MDM-szolgáltató beállítása</h3>
                                            <p>Ismerje meg a mobileszköz-felügyelet szolgáltatójának kiválasztásakor felmerülő lehetőségeket.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Eszközprofilok konfigurálása</h3>
                                            <p>Ismerje meg, hogyan hozhat létre eszközkonfigurációs profilokat az Intune-ban.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Eszközkorlátozások beállítása</h3>
                                            <p>Ismerje meg, hogyan konfigurálhatja az eszközkorlátozási beállításokat az Intune-ban.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Alkalmazások kezelése</h3>
                                            <p>Ismerje meg, hogyan vehet fel, oszthat ki és monitorozhat alkalmazásokat.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Alkalmazásvédelmi szabályzatok létrehozása és hozzárendelése</h3>
                                            <p>Ismerkedjen meg az alkalmazásvédelmi szabályzatok létrehozásának és hozzárendelésének mikéntjével.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<!--                        <li>
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3><a href="/intune/device-enrollment">A teljes útmutató dokumentáció</a></h3>
                            </div>
                        </li>
                    </ul>
                </li>
                <li>
                    <a href="#manage-troubleshoot">Monitorozás és hibaelhárítás</a>
                    <ul id="manage-troubleshoot" class="cardsC">
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Támogatáskérés az Intune-hoz</h3>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Ismert problémák</h3>
                                            <p>Tájékozódhat az Intune esetleges ismert problémáiról.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Alkalmazástelepítéssel kapcsolatos problémák elhárítása</h3>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Eszközregisztrációval kapcsolatos problémák elhárítása</h3>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Eszközprofilokkal kapcsolatos problémák elhárítása</h3>
                                            <p>Oldja meg az eszközprofilok létrehozása során jelentkező problémákat.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Az e-mail-profilok hibaelhárítása</h3>
                                            <p>Oldja meg az e-mail-profilok létrehozása során jelentkező problémákat.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3><a href="/intune-classic/troubleshoot/general-troubleshooting-tips-for-microsoft-intune">A teljes hibaelhárítási dokumentáció</a></h3>
                            </div>
                        </li>
                    </ul>
                </li>
        ...
        <li>
            <a href="#sdkstools">SDK-k és eszközök</a>
            <ul id="sdkstools">
                <li>
                    ...
                    <ul id="sdkstools-all" class="cardsC">                       
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Az Intune App SDK áttekintése</h3>
                                            <p>Ismerje meg az alkalmazását az Intune alkalmazásvédelmi szabályzataira felkészítő SDK-t.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            ...
                                            <p>Ez az útmutató végigvezeti azokon a fő lépéseken, amelyekkel engedélyezheti az alkalmazás felügyeletét a Microsoft Intune-ban.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            ...
                                            <p>Az iOS-hez készült Intune App SDK magában foglalja a statikus könyvtárat, az erőforrásfájlokat, az API-fejléceket, a hibakeresési beállításokat tartalmazó listafájlt és a konfiguráló eszközt.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Üzletági alkalmazások előkészítése mobilalkalmazás-felügyelethez</h3>
                                            <p>Az Intune alkalmazásburkoló eszközével vagy az Intune App SDK-val engedélyezheti, hogy az alkalmazások mobilalkalmazás-felügyeleti (MAM) szabályzatokat használjanak.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3>Az egész dokumentációra szüksége van? <a href="/intune-classic/understand-explore/introduction-to-microsoft-intune">A teljes Intune-dokumentáció</a></h3>
                            </div>
                        </li>
                    </ul>
                </li>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Visszajelzés az Intune-ról</h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Kövesse Twitteren a Microsoft Intune-t</h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Kérdéseit vagy válaszait írja meg a fórumra</h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Visszajelzés az Intune szolgáltatásról</h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Visszajelzés az Intune dokumentációjáról</h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
