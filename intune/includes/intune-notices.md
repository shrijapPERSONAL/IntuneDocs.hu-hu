...
Ez a változás márciusban jelennek meg, amikor regisztrációs profilokat az Intune-ban az Azure Portalon fog frissülni, így megadhatja, hogy miképpen hitelesítik eszközök, és ha kapnak a vállalati portál alkalmazás. Továbbfejlesztett munkafolyamatot az iOS-eszközök regisztrálása a fenti módszerek keresztül lesz. Megjegyezés:
