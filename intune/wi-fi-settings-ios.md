---
title: A Microsoft Intune Wi-Fi-beállításainak konfigurálása iOS rendszerű eszközökhöz
titleSuffix: ''
description: Az iOS-eszközök Intune-beli Wi-Fi-konfigurációs beállításainak ismertetése
keywords: ''
...
Ez a cikk bemutatja a Microsoft Intune-ban a iOS rendszerű eszközökhöz konfigurálható Wi-Fi-beállításokat.
