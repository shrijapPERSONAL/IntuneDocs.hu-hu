...
description: Céges tulajdonú iOS-es eszközök regisztrálása az Apple készülékregisztrációs programjával (DEP) (új felhasználói felület).
keywords: ''
author: ErikjeMS
ms.author: erikje
manager: dougeby
...
>
> Ha azonban az **Eszközök beléptetése** lap az alábbi képen láthatóhoz hasonló, akkor a fiókja még nem lett frissítve az új felhasználói felületre. Látogasson el [erre a súgólapra](device-enrollment-program-enroll-ios.md).
>
...
2. Kattintson a **Nyilvános kulcs letöltése** elemre a titkosításikulcs-fájl (.pem) letöltéséhez és helyi mentéséhez. A .pem fájllal megbízhatósági kapcsolati tanúsítványt kérhet az Apple Device Enrollment Program portálról.
  ![Képernyőkép – A Készülékregisztrációs program tokenje panel az Apple tanúsítványok munkaterületen – nyilvános kulcs letöltése.](./media/device-enrollment-program-enroll-ios/image02.png)
