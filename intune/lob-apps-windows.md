...
A létrehozott alkalmazás megjelenik az alkalmazáslistában, így tetszőleges csoportokhoz hozzárendelheti. További segítségért lásd: [Alkalmazások hozzárendelése csoportokhoz](apps-deploy.md).
