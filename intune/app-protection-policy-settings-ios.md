...
| **Az Intune alkalmazásvédelmi szabályzat minimális SDK-verziójának megkövetelése** | Válassza az **Igen** lehetőséget az Intune alkalmazásvédelmi szabályzat az alkalmazás által kötelezően használandó minimális SDK-verziójának megköveteléséhez. A felhasználó hozzáférése le lesz tiltva, ha az Intune alkalmazásvédelmi szabályzat SDK-verziója nem felel meg a követelménynek. <br> <br> Az Intune alkalmazásvédelmi szabályzat SDK-val kapcsolatos további tudnivalókért lásd: [Az Intune App SDK áttekintése](/intune-classic/develop/intune-app-sdk) <br><br> | Nem |
