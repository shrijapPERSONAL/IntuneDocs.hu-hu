...
-   További információk a következő cikkben találhatók: [Drive end-user adoption with conditional access](migration-guide-drive-adoption.md) (A végfelhasználói bevezetés ösztönzése feltételes hozzáféréssel).
...
-   Az [A végfelhasználók oktatása az Intune használatával kapcsolatban](/intune/end-user-educate) című témakörben talál további útmutatást a regisztráláshoz az egyes mobiloperációsrendszer-platformok esetében
