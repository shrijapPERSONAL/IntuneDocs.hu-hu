...
- Ha mégis egy olyan eszközre telepíti az Office-t, amelyen az Office már megtalálható, vegye figyelembe a következőket:
    - A használt Office-verziótól függetlenül 32 bites és 64 bites Office-termékek nem telepíthetők ugyanarra az eszközre.
    - Az Office Kattintásra- és MSI-verzióinak ugyanazon verzióját nem lehet telepíteni ugyanarra az eszközre, különböző főverziók viszont telepíthetők.
    - Ha már rendelkezik az Office egy korábbi verziójával, melyet a Kattintásra szolgáltatással telepített, el kell távolítania minden olyan alkalmazást, melyet újabb verzióra szeretne cserélni. Ha például a Word egy régebbi verziójával rendelkezik az eszközön, és a legújabb verziót szeretné hozzárendelni, először el kell távolítania a régi verziót.
    - Ha egy eszközön már telepítve van az Office 365, lehetséges, hogy az Office 365 ProPlus 2016 csomag az eszközhöz való hozzárendeléséhez módosítania kell az Office-előfizetés szintjét.
