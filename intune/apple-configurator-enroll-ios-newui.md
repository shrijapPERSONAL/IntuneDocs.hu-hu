...
>
>Ha azonban az **Eszközök beléptetése** lap az alábbi képen láthatóhoz hasonló, akkor a fiókja még nem lett frissítve az új felhasználói felületre. Látogasson el [erre a súgólapra](apple-configurator-enroll-ios.md).
>
